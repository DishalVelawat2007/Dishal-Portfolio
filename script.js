...
function openGmail() {
  const email = "dishalvelawat@gmail.com";
...
function downloadCV() {
  ...
  link.href = "Dishal Velawat Resume.pdf"; // Path to your resume file
  link.download = "Dishal Velawat Resume"; // Name for the downloaded file
